...
// package onload provides a minimal document on-ready trigger for GopherJS.
// It is adapted from http://stackoverflow.com/a/9899701/13860
package onload
...
var readyList []func() = make([]func(), 0)
